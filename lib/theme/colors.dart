...
final class CustomColors {
  static Color primary = const Color.fromARGB(255, 74, 108, 244);
  static Color primaryVariant = const Color(0xFF3700B3);
  static Color secondary = const Color(0xFF03DAC6);
  static Color secondaryVariant = const Color(0xFF018786);
